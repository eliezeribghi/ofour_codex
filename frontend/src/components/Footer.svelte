...
<footer class="footer-grid">
  <section class="newsletter-section">
    <form action="" method="post">
      ...
      <input class="input" type="email" name="email" id="" placeholder="exemple@domaine.com">
  ...
  <section class="nav-links-section">
    <ul>
      <li><a href="/" class="nav-menu__link" aria-label="Page d'accueil du site">Accueil</a></li>
      <li><a href="lien2.html">Recettes</a></li>
      <li><a href="lien3.html">Formulaire de Proposition de Recettes</a></li>
      <li><a href="lien4.html">Mentions légales</a></li>
    </ul>
  </section>
  <section class="propos-section">
    <a href="lien5.html">Contact</a>
    <ul>
